...
python3 -m torch.distributed.launch  --nproc_per_node=8  --nnodes=1  --node_rank=0  --master_addr=100.64.229.103  --master_port=4000  main_linprobe.py  --batch_size 1024  --accum_iter 2  --num_workers 7  --model vit_base_patch16  --dataset 'lgs117'  --epochs 40  --blr 0.1  --weight_decay 0.0  --pin_mem  --dist_eval  --data_path "/home/ubuntu/project/data/LGS"  --nb_classes 117  --log_dir "/home/ubuntu/project/MAE/LGS+IN/nonorm_loss_pretrained_balanced/linprob_lgs117/"  --output_dir "/home/ubuntu/project/MAE/LGS+IN/nonorm_loss_pretrained_balanced/linprob_lgs117/"  --finetune "/home/ubuntu/project/MAE/LGS+IN/nonorm_loss_pretrained_balanced/checkpoint-149.pth"
```
```
...
python3 -m torch.distributed.launch  --nproc_per_node=8  --nnodes=1  --node_rank=0  --master_addr=100.64.214.173  --master_port=4000  main_linprobe.py  --batch_size 2048  --accum_iter 1  --num_workers 10  --model vit_base_patch16  --dataset 'lgs117'  --epochs 40  --blr 0.1  --weight_decay 0.0  --pin_mem  --dist_eval  --data_path "/home/ubuntu/project/data/LGS"  --nb_classes 117  --log_dir "/home/ubuntu/project/MAE/LGS+IN/norm_loss/linprob_lgs117/"  --output_dir "/home/ubuntu/project/MAE/LGS+IN/norm_loss/linprob_lgs117/"  --finetune "/home/ubuntu/project/MAE/LGS+IN/norm_loss/checkpoint-399.pth"
```
```
python3 -m torch.distributed.launch  --nproc_per_node=8  --nnodes=1  --node_rank=0  --master_addr=100.64.181.53  --master_port=4000  main_linprobe.py  --batch_size 1024  --accum_iter 2  --num_workers 7  --model vit_base_patch16  --dataset 'in1k'  --epochs 60  --blr 0.1  --weight_decay 0.0  --pin_mem  --dist_eval  --data_path "/home/ubuntu/project/data/IN_data"  --nb_classes 1000  --log_dir "/home/ubuntu/project/MAE/IN/norm_loss/linprob_in1k/"  --output_dir "/home/ubuntu/project/MAE/IN/norm_loss/linprob_in1k/"  --finetune "/home/ubuntu/project/MAE/IN/norm_loss/checkpoint-799.pth"

python3 -m torch.distributed.launch  --nproc_per_node=8  --nnodes=1  --node_rank=0  --master_addr=100.64.181.53  --master_port=4000  main_linprobe.py  --batch_size 1024  --accum_iter 2  --num_workers 7  --model vit_base_patch16  --dataset 'lgs117'  --epochs 40  --blr 0.1  --weight_decay 0.0  --pin_mem  --dist_eval  --data_path "/home/ubuntu/project/data/LGS"  --nb_classes 117  --log_dir "/home/ubuntu/project/MAE/IN/norm_loss/linprob_lgs117/"  --output_dir "/home/ubuntu/project/MAE/IN/norm_loss/linprob_lgs117/"  --finetune "/home/ubuntu/project/MAE/IN/norm_loss/checkpoint-799.pth"
```
